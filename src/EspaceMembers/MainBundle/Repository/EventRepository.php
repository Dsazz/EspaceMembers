...
class EventRepository extends EntityRepository
{
    ...
    public function filterByTagTeachingsAndEvents($tagId)
    {
        ...
        $rsm->addJoinedEntityResult('Application\Sonata\MediaBundle\Entity\Media', 'frntImg', 'ev', 'frontImage');
        ...
        $rsm->addJoinedEntityResult('Application\Sonata\UserBundle\Entity\User', 'u', 'ev', 'users');
        $rsm->addFieldResult('u', 'user_id', 'id');
        $rsm->addFieldResult('u', 'lastname', 'lastname');
        $rsm->addFieldResult('u', 'firstname', 'firstname');

        $rsm->addJoinedEntityResult('Application\Sonata\MediaBundle\Entity\Media', 'avatar', 'u', 'avatar');
        ...
        $rsm->addJoinedEntityResult('Application\Sonata\MediaBundle\Entity\Media', 'lsn', 'tch', 'lesson');
        ...
        $sql =
            ...
            'JOIN users_teachings as tu ON tu.user_id = u.id '.
            ...
            'ORDER BY tch.serial ASC, ev.year DESC )'.
